...
<body>
  ...
  <div class="contenedor_imagen_principal_prod ancho">
    <div class="sorbetes">
      <h2 class="titulo_helados">Sorbetes</h2>
      
    </div>
    <div class="dulces">
      <h2 class="titulo_dulces">Dulces</h2>
    </div>
  </div>
  ...
  <div class="ancho contenedor_nuestros_productos">
    ...
    <div class="contenedor_sorbetes_li">
      ...
      <a href="codigo_de_barra_dulce.php?id_dulces=<?php echo $fila['id_dulces']; ?>"><img src="<?php echo $fila["ruta"];?>" class="img_sorbete"></a>
        ...
        <a href="codigo_de_barra_dulce.php?id_dulces=<?php echo $fila['id_dulces']; ?>"> <p class="texto-sorbete"><?php echo $fila["codigo"]?></p></a>
      </div>
      <?php }?>
    </div>
  </div>
