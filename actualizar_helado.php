...
$insertar = "UPDATE helados SET  helado = '$helado', descripcion='$descripcion', precio='$precio', ruta='$rutaDestino' WHERE id_helados = '$id'";
$query = mysqli_query($conectar, $insertar);
if ($query) {
echo '
<script>
alert("SE GUARDO EL EDITO EL HELADO CORRECTAMENTE");
...
echo '
<script>
alert("HUBO UN PROBLEMA AL EDITAR EL HELADO, INTENTE DE NUEVO");
 window.history.go(-1);
</script>
';
}
