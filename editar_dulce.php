           ...
           ?>
            ...
            <div class="contenedor5 ">
                ...
                <div class="ancho contenedor6">
                    <form action="actualizar_dulce.php" method="POST" autocomplete="off" enctype="multipart/form-data">
                        <p class="negritas">Porfavor, llene los siguientes campos:</p>

                        <input class="campos_login" type="text" placeholder="Nombre del Dulce" name="dulce" required  value="<?php echo $fila['dulce'];?>">
                        <br><br>
                        ...
                        <br><br>
                        <input type="hidden" name="id" value="<?php echo $fila['id_dulces'];?>">
                         <button  class="registrar_admin">Editar Dulce</button>
